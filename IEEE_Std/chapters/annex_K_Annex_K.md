...
IEEE Std #define XXTERN PLI_EXTERN PLI_DLLISPEC
...
IEEE Std #define vpiRepeatControl 52 /* repeat control in an assign stmt */
...
IEEE Std #define vpiTchkDataTerm 86 /* timing check data term */
...
IEEE Std #define vpiTimeUnit 11 /* module time unit */
...
IEEE Std /************************ gate and terminal properties ************************/
...
IEEE Std #define vpiWidth 4 /* $width */
...
IEEE Std #define vpiStringConst 6 /* string literal */
...
IEEE Std /*********************** properties added with 1364-2005 **********************/
...
IEEE Std /*********************** system task/function structure ***********************/
...
IEEE Std p_vpi_time time; /* callback time */
...
IEEE Std XXTERN vpiHandle vpi_register_systf PROTO_PARAMS((p_vpi_systf_data
systf_data_p));
...
IEEE Std XXTERN PLI_UINT32 vpi_mcd_open PROTO_PARAMS((PLI_BYTE8 *fileName));
