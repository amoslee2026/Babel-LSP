...
IEEE Std | { attribute_instance } bind_directive
| config_declaration
...
IEEE Std program_nonansi_header ::=
...
IEEE Std | { attribute_instance } module_instantiation
...
IEEE Std cell_clause ::= cell [ library_identifier . ] cell_identifier
...
IEEE Std class_constructor_declaration ::=
...
IEEE Std | interconnect implicit_data_type [ # delay_value ]
...
IEEE Std A.2.4 Declaration assignments
...
IEEE Std A.2.6 Function declarations
...
IEEE Std concurrent_assertion_statement ::=
...
IEEE Std | sequence_instance [ sequence_abbrev ]
...
IEEE Std A.2.11 Covergroup declarations
covergroup_declaration ::=
...
IEEE Std covergroup_expression ::= expression33
...
IEEE Std A.3.2 Primitive strengths
pulldown_strength ::=
( strength0 , strength1 )
| ( strength1 , strength0 )
| ( strength0 )
...
IEEE Std list_of_port_connections34 ::=
...
IEEE Std combinational_body ::= table combinational_entry { combinational_entry } endtable
...
IEEE Std | procedural_timing_control_statement
| seq_block
| wait_statement
...
IEEE Std loop_variables ::= [ index_variable_identifier ] { , [ index_variable_identifier ] }
...
IEEE Std A.6.11 Clocking block
clocking_declaration ::=
...
IEEE Std rs_code_block ::= { { data_declaration } { statement_or_null } }
rs_prod ::=
rs_production_item
| rs_code_block
| rs_if_else
...
IEEE Std parallel_edge_sensitive_path_description ::=
...
IEEE Std trise_path_delay_expression ::= path_delay_expression
...
IEEE Std [ , [ notifier ] [ , [ timestamp_condition ] [ , [ timecheck_condition ]
[ , [ delayed_reference ] [ , [ delayed_data ] ] ] ] ] ] ) ;
$skew_timing_check ::=
...
IEEE Std specify_terminal_descriptor ::=
...
IEEE Std tf_call42 ::= ps_or_hierarchical_tf_identifier { attribute_instance } [ ( list_of_arguments ) ]
system_tf_call ::=
...
IEEE Std constant_range_expression ::= constant_expression | constant_part_select_range
...
IEEE Std | constant_function_call [ [ constant_range_expression ] ]
...
IEEE Std A.8.5 Expression left-side values
net_lvalue ::=
...
IEEE Std block_comment ::= /* comment_text */
...
IEEE Std interface_port_identifier ::= identifier
...
IEEE Std specparam_identifier ::= identifier
...
IEEE Std 17) When a packed dimension is used with the struct keyword, the packed keyword shall also be used. When a
...
IEEE Std 45) It shall be legal to use a type_reference constant_primary as the casting_type in a static cast. It shall be illegal for a
