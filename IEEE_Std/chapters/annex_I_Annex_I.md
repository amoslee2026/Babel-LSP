...
IEEE Std /* Use to import a symbol into dll */
...
IEEE Std #define SV_PACKED_DATA_NELEMS(WIDTH) (((WIDTH) + 31) >> 5)
/*
...
IEEE Std XXTERN void svPutLogicArrElem3(const svOpenArrayHandle d, svLogic value, int indx1,
int indx2, int indx3);
...
IEEE Std * to svPutUserData() was never made.
*/
